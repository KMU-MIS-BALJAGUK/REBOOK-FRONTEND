...
const styles = StyleSheet.create({
  ...
  body: { fontSize: 12, lineHeight: 18, color: '#443b30' },
  flowCard: {
    borderWidth: 1.5,
    borderColor: '#111',
    backgroundColor: '#fff',
  ...
  flowIndex: { fontSize: 10, color: '#6a6156', fontWeight: '900' },
  flowText: { fontSize: 12, color: '#2f2a24', fontWeight: '700' },
  generateButton: {
    minHeight: 48,
    borderWidth: 1.5,
    borderColor: '#111',
  ...
  stateCardBlue: { backgroundColor: '#e7f7fd' },
  stateCardRed: { backgroundColor: '#fff0eb' },
  stateCardYellow: { backgroundColor: '#fff8dd' },
  stateTitle: { fontSize: 16, lineHeight: 22, color: '#171512', fontWeight: '900' },
  stateBody: { fontSize: 12, lineHeight: 18, color: '#5b544b' },
  summaryCard: {
    borderWidth: 1.5,
    borderColor: '#111',
    backgroundColor: '#fff',
  ...
  generatedAt: { fontSize: 10, color: '#75695c' },
  metaRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 10 },
  metaLabel: { fontSize: 11, color: '#75695c', fontWeight: '700' },
  ...
  topicDescription: { fontSize: 12, lineHeight: 19, color: '#4d4439' },
  promptWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  promptChip: { borderWidth: 1, borderColor: '#111', backgroundColor: '#f8f4ed', paddingHorizontal: 10, paddingVertical: 7 },
  promptChipText: { fontSize: 11, color: '#2f2a24', fontWeight: '700' },
});
