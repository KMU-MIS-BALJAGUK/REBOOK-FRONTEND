...
import { toMyProfile, toUpdateBioRequestDto, toUpdateNicknameRequestDto } from '../model/myProfile.mapper';
import { MyProfileResponseDto, UpdateBioRequestDto, UpdateNicknameRequestDto } from '../model/myProfile.dto';
import { MyProfile, UpdateBioInput, UpdateNicknameInput } from '../model/myProfile.types';
