...
export function FreeReadingReportGenerationModal({ visible, mode, status, report, errorMessage, onClose, onStartGenerate }: Props) {
      ...
      <Pressable style={styles.backdrop} onPress={onClose}>
        <View style={styles.sheetWrap}>
          <Pressable style={styles.card} onPress={() => undefined}>
            ...
            {mode === 'intro' ? (
              <View style={styles.introWrap}>
                ...
                <TouchableOpacity style={styles.startButton} onPress={onStartGenerate}>
                  <Text style={styles.startButtonText}>리포트 생성하기</Text>
                </TouchableOpacity>
              </View>
            ) : null}

            {mode !== 'intro' && !showResult ? (
            ...
            {mode !== 'intro' && status === 'error' ? (
              <TouchableOpacity style={styles.closeInsideButton} onPress={onClose}>
