...
const styles = StyleSheet.create({
  ...
  methodTitle: { fontSize: 14, color: '#111', fontWeight: '700', marginBottom: 2 },
  methodItem: {
    borderWidth: 1,
    borderColor: '#dbe3ea',
    backgroundColor: '#fff',
  ...
  methodItemTitle: { fontSize: 13, color: '#111', fontWeight: '600' },
  methodItemSub: { fontSize: 11, color: '#66707a', marginTop: 2 },
});
